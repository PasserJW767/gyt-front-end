...
export default {
  name: "GuoYiTangHotChoose",
  data() {
    return {
    }
  },
  methods: {
    ...mapMutations(['mChoiceFlag','mPageSize','mGytHospitalList']),
    //改变颜色的方法
    changeColor() {
  ...
  computed: {
    ...mapGetters(['choiceFlag','gytHospitalList'])
  },
}
</script>
